...
class Service:
    def __init__(self, date: datetime.datetime, operation: str, price: int):
        self.date = date
...
class Car:
    def __init__(self, name: str, model: CarModel, bought: datetime.datetime, price: int, boughtplace: str):
        self.name = name
        self.model = model
        self.bought = bought
        self.price = price
