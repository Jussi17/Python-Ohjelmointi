...
class Havainto:
    def __init__(self, lintulaji: str, maara: int, tyyppi: str, havaintopvm: datetime.datetime, paikka: str,
                 kuvaus: str):
    ...
    def __str__(self):
        return (f"Lintulaji: {self.lintulaji}, Määrä: {self.maara}, Tyyppi: {self.tyyppi}, "
                f"Havaintopvm: {self.havaintopvm.strftime('%d.%m.%Y')}, Paikka: {self.paikka}, Kuvaus: {self.kuvaus}")


if __name__ == "__main__":
    havainto = Havainto("Varis", 7, "Paikallinen", datetime.datetime(2025, 3, 31), "Vantaa",
                        "Havainto pihalla")
    print(havainto)
